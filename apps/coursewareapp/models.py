...
class Courseware(models.Model):
    ...
    file = models.FileField(upload_to='upload/courseware/%Y%m%d', max_length=200, verbose_name='公告路径')
    size = models.CharField(max_length=20, verbose_name='文件大小', editable=False)
